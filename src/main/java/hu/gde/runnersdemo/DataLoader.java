...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        shoeNameEntity1.setShoeName("Adidas");
        ...
        runnerEntity.setShoeNameEntity(shoeNameEntity1);
        shoeNameEntity1.getRunners().add(runnerEntity);
        ...
        runnerEntity2.setShoeNameEntity(shoeNameEntity2);
        shoeNameEntity2.getRunners().add(runnerEntity2);
        ...
        runnerEntity3.setShoeNameEntity(shoeNameEntity3);
        shoeNameEntity3.getRunners().add(runnerEntity3);
